...
{	
	...
	public partial class Contact : Microsoft.Xrm.Sdk.Entity, System.ComponentModel.INotifyPropertyChanging, System.ComponentModel.INotifyPropertyChanged
	{
		...
		public System.Nullable<MoC.TypedEntities.ContactState> StateCode
		{
			get
			{
				...
				if ((optionSet != null))
				{
					return ((MoC.TypedEntities.ContactState)(System.Enum.ToObject(typeof(MoC.TypedEntities.ContactState), optionSet.Value)));
				}
				else
				{
					return null;
		...
		public System.Collections.Generic.IEnumerable<MoC.TypedEntities.Account> account_primary_contact
		{
			get
			{
				return this.GetRelatedEntities<MoC.TypedEntities.Account>("account_primary_contact", null);
			}
			set
			{
				this.OnPropertyChanging("account_primary_contact");
				this.SetRelatedEntities<MoC.TypedEntities.Account>("account_primary_contact", null, value);
		...
		public System.Collections.Generic.IEnumerable<MoC.TypedEntities.Contact> Referencedcontact_customer_contacts
		{
			get
			{
				return this.GetRelatedEntities<MoC.TypedEntities.Contact>("contact_customer_contacts", Microsoft.Xrm.Sdk.EntityRole.Referenced);
			}
			set
			{
				this.OnPropertyChanging("Referencedcontact_customer_contacts");
				this.SetRelatedEntities<MoC.TypedEntities.Contact>("contact_customer_contacts", Microsoft.Xrm.Sdk.EntityRole.Referenced, value);
		...
		public System.Collections.Generic.IEnumerable<MoC.TypedEntities.Contact> Referencedcontact_master_contact
		{
			get
			{
				return this.GetRelatedEntities<MoC.TypedEntities.Contact>("contact_master_contact", Microsoft.Xrm.Sdk.EntityRole.Referenced);
			}
			set
			{
				this.OnPropertyChanging("Referencedcontact_master_contact");
				this.SetRelatedEntities<MoC.TypedEntities.Contact>("contact_master_contact", Microsoft.Xrm.Sdk.EntityRole.Referenced, value);
		...
		public MoC.TypedEntities.Account contact_customer_accounts
		{
			get
			{
				return this.GetRelatedEntity<MoC.TypedEntities.Account>("contact_customer_accounts", null);
			}
			set
			{
				this.OnPropertyChanging("contact_customer_accounts");
				this.SetRelatedEntity<MoC.TypedEntities.Account>("contact_customer_accounts", null, value);
		...
		public MoC.TypedEntities.Contact Referencingcontact_customer_contacts
		{
			get
			{
				return this.GetRelatedEntity<MoC.TypedEntities.Contact>("contact_customer_contacts", Microsoft.Xrm.Sdk.EntityRole.Referencing);
			}
			set
			{
				this.OnPropertyChanging("Referencingcontact_customer_contacts");
				this.SetRelatedEntity<MoC.TypedEntities.Contact>("contact_customer_contacts", Microsoft.Xrm.Sdk.EntityRole.Referencing, value);
		...
		public MoC.TypedEntities.Contact Referencingcontact_master_contact
		{
			get
			{
				return this.GetRelatedEntity<MoC.TypedEntities.Contact>("contact_master_contact", Microsoft.Xrm.Sdk.EntityRole.Referencing);
			}
		}
	}
}